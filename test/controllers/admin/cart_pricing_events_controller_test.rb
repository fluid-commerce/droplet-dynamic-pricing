...
describe Admin::CartPricingEventsController do
  fixtures(:companies)

  describe "authentication" do
    it "allows access without authentication when dri is provided" do
      company = companies(:acme)
      get admin_cart_pricing_events_path(dri: company.droplet_installation_uuid)

      must_respond_with :success
    end

    it "returns 404 when company is not found" do
      get admin_cart_pricing_events_path(dri: "non-existent-uuid")
