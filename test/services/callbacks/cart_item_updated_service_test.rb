...
class Callbacks::CartItemUpdatedServiceTest < ActiveSupport::TestCase
  ...
  test "call returns failure when cart is blank" do
    service = Callbacks::CartItemUpdatedService.new({ cart: nil, cart_item: @cart_item })
    result = service.call
  ...
  test "call returns failure when cart_item is blank" do
    service = Callbacks::CartItemUpdatedService.new({ cart: @cart_data, cart_item: nil })
    result = service.call
  ...
  test "call returns success without updates when no preferred_customer and no subscription in cart" do
    ...
    service = Callbacks::CartItemUpdatedService.new({
  ...
  test "call processes cart_item_updated successfully when price_type is preferred_customer" do
    fake_carts = FakeCartsResource.new
    mock_client = Object.new
    mock_client.define_singleton_method(:carts) { fake_carts }
  ...
  test "class method call works" do
    ...
    Callbacks::CartItemUpdatedService.stub(:new, ->(params) { service_instance }) do
      result = Callbacks::CartItemUpdatedService.call(@callback_params)
