...
import type { CartEvent } from "@/lib/dashboard/types";
import { labelForEventType } from "@/lib/dashboard/event-labels";
      ...
      <div>
        <table className="w-full">
          <thead className="border-b">
            <tr>
              <th className="pl-6 py-4 text-left text-sm font-semibold text-foreground">
                Date/Time
              </th>
              ...
              <th className="pr-6 py-4 text-left text-sm font-semibold text-foreground">
                Status
              </th>
            </tr>
          </thead>
