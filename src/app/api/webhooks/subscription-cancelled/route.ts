 ...
 *
 * Rails route: `POST /webhook/subscription_cancelled`.
 * Next route:  `POST /api/webhooks/subscription-cancelled`.
 *
...
export const POST = subscriptionWebhookRoute("cancelled");
